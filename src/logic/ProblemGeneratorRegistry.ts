...
export class ProblemGeneratorRegistry {
    ...
    public register(problemGeneratorCtor: ProblemGeneratorCtor, persistencyKey: string): void {
        this.problemGeneratorMap.set(persistencyKey, problemGeneratorCtor);
        Object.defineProperty(problemGeneratorCtor.prototype as ProblemGeneratorPrototype, "persistencyKey", {
