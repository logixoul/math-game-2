export class InlineJsAssets {
    arrow: string = `<svg fill="#000000" height="20px" width="20px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
export const inlineJsAssets = new InlineJsAssets();
